...
jql_query = 'project = "ID Business Intelligence"'
max_results = 1  # Replace 100 with the desired maximum number of results

# Construct the URL with both JQL query and maxResults
endpoint = f'{base_url}/rest/api/2/search?jql={jql_query}&maxResults={max_results}'
